...
current_dir = "cameroon/nord-ouest"
raw_file = f'{root_dir}/power-outages-data/{current_dir}/raw/{current_year}/{current_month}/power_outages.cm.nord-ouest.raw.{current_date}.json'
