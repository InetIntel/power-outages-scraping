...
current_dir = "cameroon/adamaoua"
raw_file = f'{root_dir}/power-outages-data/{current_dir}/raw/{current_year}/{current_month}/power_outages.cm.adamaoua.raw.{current_date}.json'
