...
def update_raw_data(pre_existing_raw_outage_data, new_raw_outage_data):
    ...
    for id in all_ids:
        ...
        # if outage is ongoing
            ...
            num_people_affected = max(0, previous_outage_data['attributes']['affected_client'], new_outage_data['attributes']['affected_client'])
...
if __name__ == "__main__":
    ...
    pre_existing_raw_outages = get_pre_existing_raw_outages(current_datetime, bucket_name='spain', provider_name='edistribucion')
    ...
    upload_raw(updated_raw_data, current_datetime, bucket_name='spain', provider_name='edistribucion')
