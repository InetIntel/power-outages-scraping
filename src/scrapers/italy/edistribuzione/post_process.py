...
def process_data(resolved_outages):
    ...
    for outage in resolved_outages:
        ...
        # get event category
        if type(outage['attributes']['causa_disalimentazione']) == 'Lavoro Programmato':
        ...
        processed_outage = {
            ...
            'clients_affected': outage['attributes']['num_cli_disalim'],
...
def upload_processed_data(new_processed_data, current_datetime, bucket_name, provider_name, country_code):
    """
    ...
    try:
        ...
        filename = f'power_outages.{country_code}.{provider_name}.processed.{current_year}-{current_month}-{current_day}.json'
...
if __name__ == "__main__":
    ...
    get_existing_outages(bucket_name='italy', provider_name='edistribuzione')
    ...
    upload_processed_data(processed_data, current_datetime, bucket_name='italy', provider_name='edistribuzione', country_code='IT')