...
def post_process(date_str=None):
    ...
    raw_filename = f"power_outages.GB.sp_electricity_northwest.raw.{date_str}.json"
    raw_path = f"sp_electricity_northwest/raw/{year}/{month}/{raw_filename}"
    ...
    # Save processed JSON
    processed_filename = (
        f"power_outages.GB.sp_electricity_northwest.processed.{date_str}.json"
    )
    ...
    processed_path = (
        f"sp_electricity_northwest/processed/{year}/{month}/{processed_filename}"
    )
