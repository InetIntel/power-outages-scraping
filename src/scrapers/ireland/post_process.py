...
def download_raw(today, year, month):
    ...
    filename = f"power_outages.{COUNTRY_CODE}.{FILE_PREFIX}.raw.{today}.json"
...
def upload_processed(data, today, year, month):
    ...
    """
    filename = f"power_outages.{COUNTRY_CODE}.{FILE_PREFIX}.processed.{today}.json"
