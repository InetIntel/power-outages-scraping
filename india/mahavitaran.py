...
class Mahavitaran:
    ...
    def check_folder(self):
        self.folder_path = "./data/mahavitaran/" + self.month
...
url = "https://www.mahadiscom.in/consumer/en/weekly-outage-data/"
months = get_months(url)
# mahavitaran = Mahavitaran(url, months[0])
# mahavitaran.run()
for month in months:
    mahavitaran = Mahavitaran(url, month)
    mahavitaran.run()
