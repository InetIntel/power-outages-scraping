...
current_dir = "ukraine/zhytomyr"
raw_file = f'{root_dir}/power-outages-data/{current_dir}/raw/{current_year}/{current_month}/power_outages.UA.zhytomyr.raw.{current_date}.json'
